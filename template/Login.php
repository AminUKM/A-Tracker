...
<head>
    <title>Login</title>
    <meta charset="UTF-8">
    <link rel="shortcut icon" href="/static/images/APlusTracker.ico">
...
<body>
    <div class="login-container">
        ...
        <form method="POST" autocomplete="off" style="display:flex; flex-direction:column; align-items:center; gap:18px;">
            <div style="width:100%;">
                <input type="text" name="matric" placeholder="Matric Number" required class="input-box" style="box-sizing:border-box;" autocomplete="off">
            </div>
            <div style="position:relative; width:100%;">
                <input type="password" name="password" id="password" placeholder="Password" required class="input-box" style="box-sizing:border-box;" autocomplete="new-password">
        ...
        <div style="text-align:center; margin-top:18px; font-size:0.97rem;">
            If you are new user, please 
            <a href="signup.php" style="color:#2575fc; font-weight:600; text-decoration:underline; transition:color 0.2s;">register</a>
        </div>
        <?php
        if (isset($error)) {
        ...
        <script>
            ...
            toggle.addEventListener('click', function() {
                ...
                // Change icon style (simple toggle for demonstration)
